...
class Candidate extends AbstractActor {
    ...
    private void process() {
        ...
        try {
            ...
            logger.warn("{} Timeout occurred during the election process. If you see this message many times consecutively consider to increase the election timeout or follower timeout offset. {}", this.getId(), e);
            this.raft.changeActor(new Follower(this.raft));
            return;
        }
