...
import com.balazskreith.vstorage.raft.events.Events;
import com.balazskreith.vstorage.raft.events.RaftTransport;
import com.balazskreith.vstorage.rxutils.RxAtomicReference;
...
public class RxRaft implements Disposable, Closeable {
    ...
    private final RxAtomicReference<UUID> actualLeaderId = new RxAtomicReference<>(null);
