...
public interface InboundEvents extends Disposable {
    static InboundEvents createFrom(Events events) {
        return new InboundEvents() {
            ...
            @Override
            public Observer<RaftAppendEntriesRequestChunk> appendEntriesRequests() {
    ...
    Observer<RaftAppendEntriesRequestChunk> appendEntriesRequests();
    ...
    default InboundEvents observeOn(Scheduler scheduler) {
        ...
        result.appendEntriesRequestChunk().observeOn(scheduler).subscribe(this.appendEntriesRequests());
