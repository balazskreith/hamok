...
import io.github.balazskreith.hamok.racoon.events.*;
...
abstract class AbstractState implements Runnable {
    ...
    protected Racoon base;

    protected AbstractState(Racoon base) {
        this.base = base;
    }
    ...
    protected void inactivatedLocalPeerId() {
        this.base.inactivatedLocalPeer();
    }
