...
import io.github.balazskreith.vstorage.storagegrid.messages.EndpointStatesNotification;
import io.github.balazskreith.vstorage.storagegrid.messages.HelloNotification;
...
//                    var stateTimer = this
    ...
    public void startSendingEndpointStates() {
        ...
        synchronized (this) {
            ...
            this.stateTimer.set(this.scheduler.createWorker().schedulePeriodically(
    ...
    private void sendEndpointStates() {
        ...
        activeEndpointIds.stream()
                .filter(endpointId -> UuidTools.notEquals(endpointId, localEndpointId))
