...
class RacoonRouter {
    private static final Logger logger = LoggerFactory.getLogger(RacoonRouter.class);
    ...
    public void add(UUID peerId, Racoon racoon) {
        var item = new Peer(
                peerId,
                racoon,
                true
    ...
    private record Peer(UUID peerId, Racoon racoon, boolean enabled) {
