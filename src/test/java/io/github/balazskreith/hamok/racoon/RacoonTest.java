...
class RacoonTest {
    ...
    private RacoonRouter router = new RacoonRouter();
    private Racoon leader;
    private Racoon follower_1;
    private Racoon follower_2;
    private Racoon stopped;
    ...
    void test_2() throws InterruptedException {
        logger.info("\n\n ---- Test 2 ----- \n\n");
        var racoon_1 = Racoon.builder().withConfig(this.createConfig()).build();
        var racoon_2 = Racoon.builder().withConfig(this.createConfig()).build();
    ...
    void test_3() throws InterruptedException {
        logger.info("\n\n ---- Test 3 ----- \n\n");
        var newRacoon = Racoon.builder().withConfig(this.createConfig()).build();
    ...
    private RacoonConfig createConfig() {
        return new RacoonConfig(
                UUID.randomUUID(),
                1000,
                1000,
                300,
