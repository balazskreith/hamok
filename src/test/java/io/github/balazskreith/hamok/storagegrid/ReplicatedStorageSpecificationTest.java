...
//        BinaryOperator<Integer> mergeOp = (itemsFromStockPile1, itemsFromStockPile2) -> itemsFromStockPile1 + itemsFromStockPile2;
    ...
    @Test
    void shouldEvict() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    @Test
    void shouldEvictAll() throws ExecutionException, InterruptedException, TimeoutException {
        Assertions.assertThrows(RuntimeException.class, () -> {
    ...
    @Test
    void shouldRestore() throws ExecutionException, InterruptedException, TimeoutException {
        Assertions.assertThrows(RuntimeException.class, () -> {
            this.storage.restore("one", 1);
        });
    }

    @Test
    void shouldRestoreAll() throws ExecutionException, InterruptedException, TimeoutException {
        Assertions.assertThrows(RuntimeException.class, () -> {
            this.storage.restoreAll(Map.of("one", 1));
        });
    }
