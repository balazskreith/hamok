...
class SeparatedStorageCheckCollidingEntriesTest {

    private static final Logger logger = LoggerFactory.getLogger(SeparatedStorageCheckCollidingEntriesTest.class);
    ...
    @Test
    @Order(3)
    @DisplayName("Resolve colliding entries")
